...
class getPurchasesListControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['App\\Controller\\Purchase\\PurchasesListController'] = $instance = new \App\Controller\Purchase\PurchasesListController(($container->privates['security.helper'] ?? $container->load('getSecurity_HelperService')), ($container->services['router'] ?? $container->getRouterService()), ($container->services['.container.private.twig'] ?? $container->get_Container_Private_TwigService()));

        $instance->setContainer(($container->privates['.service_locator.5nX7ca3'] ?? $container->load('get_ServiceLocator_5nX7ca3Service'))->withContext('App\\Controller\\Purchase\\PurchasesListController', $container));
